...
for l = 1 : numel(QualvsPostQualData)
 ...
 %% Begin A For Loop - Loop Through Limbs            
    ...
    %% Initialize Variables Within Q Loop
                                ...
                                AnkleAngleSagittal_NonTruncated_IndividualHops = NaN(4,numel(HoppingTrialNumber));
                                AnkleTorqueSagittal_IndividualHops = NaN(4,numel(HoppingTrialNumber));
                                AnkleAngleFrontal_NonTruncated_IndividualHops = NaN(4,numel(HoppingTrialNumber));
                                ...
                                AnkleAngleTransverse_NonTruncated_IndividualHops = NaN(4,numel(HoppingTrialNumber));
                                ...
                                KneeAngleSagittal_NonTruncated_IndividualHops = NaN(4,numel(HoppingTrialNumber));
                                ...
                                KneeAngleFrontal_NonTruncated_IndividualHops = NaN(4,numel(HoppingTrialNumber));
                                ...
                                KneeAngleTransverse_NonTruncated_IndividualHops = NaN(4,numel(HoppingTrialNumber));
                                ...
                                HipAngleSagittal_NonTruncated_IndividualHops = NaN(4,numel(HoppingTrialNumber));
                                ...
                                HipAngleFrontal_NonTruncated_IndividualHops = NaN(4,numel(HoppingTrialNumber));
                                ...
                                HipAngleTransverse_NonTruncated_IndividualHops = NaN(4,numel(HoppingTrialNumber));
                                HipTorqueTransverse_IndividualHops = NaN(4,numel(HoppingTrialNumber));

                                FootAngleSagittal_IndividualHops= NaN(4,numel(HoppingTrialNumber));
                                FootAngleSagittal_NonTruncated_IndividualHops= NaN(4,numel(HoppingTrialNumber));
                                ShankAngleSagittal_IndividualHops= NaN(4,numel(HoppingTrialNumber));
                                ShankAngleSagittal_NonTruncated_IndividualHops= NaN(4,numel(HoppingTrialNumber));
                                ThighAngleSagittal_IndividualHops= NaN(4,numel(HoppingTrialNumber));
                                ThighAngleSagittal_NonTruncated_IndividualHops= NaN(4,numel(HoppingTrialNumber));
                                PelvisAngleSagittal_IndividualHops= NaN(4,numel(HoppingTrialNumber));
                                PelvisAngleSagittal_NonTruncated_IndividualHops= NaN(4,numel(HoppingTrialNumber));

                                NumEl_SthHop = NaN(4,1);
                                NumEl_SthHop_MoCap = NaN(4,1);
                                NumEl_SthHopNonTruncated_MoCap = NaN(4,1);
                                ...
                                FootAngleSagittal_IndividualHopsContactPhase = NaN(3,numel(HoppingTrialNumber));
                                ...
                                %flight phase (in this case, based on minimum length of flight phase). Use tranpose because the vector is currently a row
                                ...
                                %Find the first data point of each hop, for the entire hop
                                %cycle. We classify beginning of hop cycle as first frame of
                                %flight phase (full length of flight phase, not minimum length). Use tranpose because the vector is currently a row
                                %vector, but our indexing requires a column vector   
                                FirstDataPoint_SthHopNonTruncated_MoCapSamplingHz = IndexingDataWithinHoppingRateB_DataStructure.EndGroundContact_forFlightPhase_MoCapFrames;
                                ...
                                for s = 1:numel(GContactBegin_MoCapFrameNumbers(:,q))
                                    ...
                                    %Create a vector containing all Frames for the Sth hop, from the
                                    %beginning of one flight phase (nontruncated flight phase, meaning not based on minimum length of flight phase) and the beginning of the next. Subtract
                                    %one from the GContactEnd frame number since the frame number is the
                                    %first frame of flight phase. Want to end at the last frame of contact
                                    %phase
                                    AllFrames_SthHopNonTruncated_MoCap = FirstDataPoint_SthHopNonTruncated_MoCapSamplingHz( s, q ) : (GContactEnd_forContactPhase_MoCapFrameNumbers( s, q )- 1 );

                                    %Find the last data point of each hop. Subtract 1 from the frame for
                                    %the end of ground contact phase.
                                    ...
                                    %Find the number of elements of the Sth hop.
                                    NumEl_SthHopNonTruncated_MoCap( s ) = numel(AllFrames_SthHopNonTruncated_MoCap);
    ...
    %the variable names to RAnkle... etc
                                    ...
                                    if strcmp( LimbID_forV3DOutput{a}, 'LeftLimb')
                                        ...
                                        %Split Ankle Angular Position, Torque, Power into Individual Hops
                                        %- NONTRUNCATED
                                        AnkleAngleSagittal_NonTruncated_IndividualHops(1:NumEl_SthHopNonTruncated_MoCap(s),s) =...
                                            HoppingTrialP_OriginalDataTable.LAnkle_Angle( AllFrames_SthHopNonTruncated_MoCap );
    
                                        AnkleAngleFrontal_NonTruncated_IndividualHops(1:NumEl_SthHopNonTruncated_MoCap(s),s) =...
                                            HoppingTrialP_OriginalDataTable.LAnkle_Angle_1( AllFrames_SthHopNonTruncated_MoCap );
    
                                        AnkleAngleTransverse_NonTruncated_IndividualHops(1:NumEl_SthHopNonTruncated_MoCap(s),s) =...
                                            HoppingTrialP_OriginalDataTable.LAnkle_Angle_2( AllFrames_SthHopNonTruncated_MoCap );
                                        ...
                                        %Split Knee Angular Position, Torque, Power into Individual Hops
                                        %- NONTRUNCATED
                                        KneeAngleSagittal_NonTruncated_IndividualHops(1:NumEl_SthHopNonTruncated_MoCap(s),s) =...
                                            HoppingTrialP_OriginalDataTable.LKnee_Angle( AllFrames_SthHopNonTruncated_MoCap );
    
                                        KneeAngleFrontal_NonTruncated_IndividualHops(1:NumEl_SthHopNonTruncated_MoCap(s),s) =...
                                            HoppingTrialP_OriginalDataTable.LKnee_Angle_1( AllFrames_SthHopNonTruncated_MoCap );
    
                                        KneeAngleTransverse_NonTruncated_IndividualHops(1:NumEl_SthHopNonTruncated_MoCap(s),s) =...
                                            HoppingTrialP_OriginalDataTable.LKnee_Angle_2( AllFrames_SthHopNonTruncated_MoCap );
                                        ...
                                        %Split Hip Angular Position, Torque, Power into Individual Hops -
                                        %NONTRUNCATED
                                        HipAngleSagittal_NonTruncated_IndividualHops(1:NumEl_SthHopNonTruncated_MoCap(s),s) =...
                                            HoppingTrialP_OriginalDataTable.LHip_Angle( AllFrames_SthHopNonTruncated_MoCap );
    
                                        HipAngleFrontal_NonTruncated_IndividualHops(1:NumEl_SthHopNonTruncated_MoCap(s),s) =...
                                            HoppingTrialP_OriginalDataTable.LHip_Angle_1( AllFrames_SthHopNonTruncated_MoCap );
    
                                        HipAngleTransverse_NonTruncated_IndividualHops(1:NumEl_SthHopNonTruncated_MoCap(s),s) =...
                                            HoppingTrialP_OriginalDataTable.LHip_Angle_2( AllFrames_SthHopNonTruncated_MoCap );
...
%% Split L Segment Angles into  Individual Hops
                                        ...
                                        %Split Foot Angular Position into Individual Hops
                                        FootAngleSagittal_IndividualHops( 1 : NumEl_SthHop_MoCap( s ), s ) =...
                                            HoppingTrialP_OriginalDataTable.LFoot_Angle( AllFrames_SthHop_MoCap );

                                        %Split Foot Angular Position into Individual Hops - NONTRUNCATED
                                        FootAngleSagittal_NonTruncated_IndividualHops( 1 : NumEl_SthHopNonTruncated_MoCap( s ), s ) =...
                                            HoppingTrialP_OriginalDataTable.LFoot_Angle(  AllFrames_SthHopNonTruncated_MoCap  );
                                        ...
                                        %Split Shank Angular Position into Individual Hops - NONTRUNCATED
                                        ShankAngleSagittal_NonTruncated_IndividualHops( 1 : NumEl_SthHopNonTruncated_MoCap( s ), s ) =...
                                            HoppingTrialP_OriginalDataTable.LShank_Angle(  AllFrames_SthHopNonTruncated_MoCap  );
                                        ...
                                        %Split Pelvis Angular Position into Individual Hops - NONTRUNCATED
                                        PelvisAngleSagittal_NonTruncated_IndividualHops( 1 : NumEl_SthHopNonTruncated_MoCap( s ), s ) =...
                                            HoppingTrialP_OriginalDataTable.Pelvis_Angle(  AllFrames_SthHopNonTruncated_MoCap  );
                                        ...
                                        %Split Thigh Angular Position into Individual Hops - NONTRUNCATED
                                        ThighAngleSagittal_NonTruncated_IndividualHops( 1 : NumEl_SthHopNonTruncated_MoCap( s ), s ) =...
                                            HoppingTrialP_OriginalDataTable.LThigh_Angle(  AllFrames_SthHopNonTruncated_MoCap  );  


%% Split L Segment Angles into the contact phase of Individual Hops

                                        %Split Foot Angular Position into Individual Hops
                                        FootAngleSagittal_IndividualHopsContactPhase( 1 : NumEl_SthHopContactPhase_MoCapSamplingHz(s,q), s ) =...
                                            HoppingTrialP_OriginalDataTable.LFoot_Angle( AllFrames_SthHopContactPhase_MoCap );
...
%% Split R Ankle Angular Position, Torque, Power into Individual Hops
                                        ...
                                        %NONTRUNCATED ANKLE ANGLE
                                        AnkleAngleSagittal_NonTruncated_IndividualHops(1:NumEl_SthHopNonTruncated_MoCap(s),s) =...
                                            HoppingTrialP_OriginalDataTable.RAnkle_Angle( AllFrames_SthHopNonTruncated_MoCap );
    
                                        AnkleAngleFrontal_NonTruncated_IndividualHops(1:NumEl_SthHopNonTruncated_MoCap(s),s) =...
                                            HoppingTrialP_OriginalDataTable.RAnkle_Angle_1( AllFrames_SthHopNonTruncated_MoCap );
    
                                        AnkleAngleTransverse_NonTruncated_IndividualHops(1:NumEl_SthHopNonTruncated_MoCap(s),s) =...
                                            HoppingTrialP_OriginalDataTable.RAnkle_Angle_2( AllFrames_SthHopNonTruncated_MoCap );
...
%% Split R Knee Angular Position, Torque into Individual Hops
                                        ...
                                        %NONTRUNCATED KNEE ANGLE
                                        KneeAngleSagittal_NonTruncated_IndividualHops(1:NumEl_SthHopNonTruncated_MoCap(s),s) =...
                                            HoppingTrialP_OriginalDataTable.RKnee_Angle( AllFrames_SthHopNonTruncated_MoCap );
    
                                        KneeAngleFrontal_NonTruncated_IndividualHops(1:NumEl_SthHopNonTruncated_MoCap(s),s) =...
                                            HoppingTrialP_OriginalDataTable.RKnee_Angle_1( AllFrames_SthHopNonTruncated_MoCap );
    
                                        KneeAngleTransverse_NonTruncated_IndividualHops(1:NumEl_SthHopNonTruncated_MoCap(s),s) =...
                                            HoppingTrialP_OriginalDataTable.RKnee_Angle_2( AllFrames_SthHopNonTruncated_MoCap );
...
%% Split R Hip Angular Position, Torque into Individual Hops
                                        ...
                                        %NONTRUNCATED HIP ANGLE
                                        HipAngleSagittal_NonTruncated_IndividualHops(1:NumEl_SthHopNonTruncated_MoCap(s),s) =...
                                            HoppingTrialP_OriginalDataTable.RHip_Angle( AllFrames_SthHopNonTruncated_MoCap );
    
                                        HipAngleFrontal_NonTruncated_IndividualHops(1:NumEl_SthHopNonTruncated_MoCap(s),s) =...
                                            HoppingTrialP_OriginalDataTable.RHip_Angle_1( AllFrames_SthHopNonTruncated_MoCap );
    
                                        HipAngleTransverse_NonTruncated_IndividualHops(1:NumEl_SthHopNonTruncated_MoCap(s),s) =...
                                            HoppingTrialP_OriginalDataTable.RHip_Angle_2( AllFrames_SthHopNonTruncated_MoCap );
...
%% Split R Segment Angles into  Individual Hops
                                        ...
                                        %Split Foot Angular Position into Individual Hops
                                        FootAngleSagittal_IndividualHops( 1 : NumEl_SthHop_MoCap( s ), s ) =...
                                            HoppingTrialP_OriginalDataTable.RFoot_Angle( AllFrames_SthHop_MoCap );

                                        %Split Foot Angular Position into Individual Hops - NONTRUNCATED
                                        FootAngleSagittal_NonTruncated_IndividualHops( 1 : NumEl_SthHopNonTruncated_MoCap( s ), s ) =...
                                            HoppingTrialP_OriginalDataTable.RFoot_Angle(  AllFrames_SthHopNonTruncated_MoCap  );
                                        ...
                                        %Split Shank Angular Position into Individual Hops
                                        ShankAngleSagittal_NonTruncated_IndividualHops( 1 : NumEl_SthHopNonTruncated_MoCap( s ), s ) =...
                                            HoppingTrialP_OriginalDataTable.RShank_Angle( AllFrames_SthHopNonTruncated_MoCap );
                                        ...
                                        %Split Thigh Angular Position into Individual Hops
                                        ThighAngleSagittal_NonTruncated_IndividualHops( 1 : NumEl_SthHopNonTruncated_MoCap( s ), s ) =...
                                            HoppingTrialP_OriginalDataTable.RThigh_Angle( AllFrames_SthHopNonTruncated_MoCap );
...
%% Split R Segment Angles into the contact phase of Individual Hops
                                        ...
                                        %Split Foot Angular Position into Individual Hops
                                        FootAngleSagittal_IndividualHopsContactPhase( 1 : NumEl_SthHopContactPhase_MoCapSamplingHz(s,q), s ) =...
                                            HoppingTrialP_OriginalDataTable.RFoot_Angle( AllFrames_SthHopContactPhase_MoCap );
        ...
        %% Plot Ankle Contact Phase Hops
                                    ...
                                    s_Ankle = sprintf('Angle (%c) [ - = PF ]',char(176));
                                    s_Segment = sprintf('Angle (%c) [ - = Ant. ]',char(176));
                                    ...
                                    if  strcmp( cell2mat( ShowPlots_Cell ), 'Yes' )
                                        ...
                                        if s == numel(GContactBegin_MoCapFrameNumbers(:,q) )
                                            ...
                                            figure('Color','#F5F5DC','Units', 'Normalized', 'OuterPosition', [ 0.05, 0.05, 0.9, 0.9 ],'Name',['Check Splitting of Ankle  ' ParticipantList{n} '  ' LimbID{a} '  '  ' _ ' HoppingRate_ID{b} '  ' HoppingTrialNumber{q} '  ' 'Hop# ' num2str(s)],'Visible',"on"  )
                                            ...
                                            subplot(4, 1, 3)
                                            plot(TimeVector_AnkleTorque, FootAngleSagittal_IndividualHopsContactPhase,'LineWidth',1.5)
                                            hold on
                                            L = line([0  max(TimeVector_AnkleTorque)],[0 0]);
                                            L.LineWidth = 1.2;
                                            L.Color = 'k';
                                            hold off
                                            title('Foot Angle - Contact Phase Only','FontSize',16)
                                            xlabel('Time (s)','FontSize',14)
                                            ylabel( s_Segment, 'FontSize', 14)
                                            legend('Location','bestoutside')
            ...
            %%  Plot Knee Contact Phase Hops
                                            ...
                                            s_KneeHip = sprintf('Angle (%c) [ - = Ext ]',char(176));
    
                                            figure('Color','#F5F5DC','Units', 'Normalized', 'OuterPosition', [ 0.05, 0.05, 0.9, 0.9 ],'Name',['Check Splitting of Knee  ' ParticipantList{n} '  ' LimbID{a} '  '  ' _ ' HoppingRate_ID{b} '  ' HoppingTrialNumber{q} '  ' 'Hop# ' num2str(s)],'Visible',"on"  )
            ...
            %% Plot Hip Contact Phase Hops
                                            ...
                                            figure('Color','#F5F5DC','Units', 'Normalized', 'OuterPosition', [ 0.05, 0.05, 0.9, 0.9 ],'Name',['Check Splitting of Hip  ' ParticipantList{n} '  ' LimbID{a} '  '  ' _ ' HoppingRate_ID{b} '  ' HoppingTrialNumber{q} '  ' 'Hop# ' num2str(s)],'Visible',"on"  )
        ...
        %% Store Ankle Data in Data Structure*
                                ...
                                David_DissertationDataStructure = setfield(David_DissertationDataStructure,'Post_Quals',GroupList{m}, ParticipantList{n},'IndividualHops',LimbID{a},...
                                    'Ankle','Sagittal','Angle_NonTruncated',HoppingRate_ID{b},HoppingTrialNumber{q},AnkleAngleSagittal_NonTruncated_IndividualHops);
                                ...
                                David_DissertationDataStructure = setfield(David_DissertationDataStructure,'Post_Quals',GroupList{m}, ParticipantList{n},'IndividualHops',LimbID{a},...
                                    'Ankle','Frontal','Angle_NonTruncated',HoppingRate_ID{b},HoppingTrialNumber{q},AnkleAngleFrontal_NonTruncated_IndividualHops);
                                ...
                                David_DissertationDataStructure = setfield(David_DissertationDataStructure,'Post_Quals',GroupList{m}, ParticipantList{n},'IndividualHops',LimbID{a},...
                                    'Ankle','Transverse','Angle_NonTruncated',HoppingRate_ID{b},HoppingTrialNumber{q},AnkleAngleTransverse_NonTruncated_IndividualHops);
         ...
         %% Store Knee Data in Data Structure
                                ...
                                David_DissertationDataStructure = setfield(David_DissertationDataStructure,'Post_Quals',GroupList{m}, ParticipantList{n},'IndividualHops',LimbID{a},...
                                    'Knee','Sagittal','Angle_NonTruncated',HoppingRate_ID{b},HoppingTrialNumber{q}, KneeAngleSagittal_NonTruncated_IndividualHops);
                                ...
                                David_DissertationDataStructure = setfield(David_DissertationDataStructure,'Post_Quals',GroupList{m}, ParticipantList{n},'IndividualHops',LimbID{a},...
                                    'Knee','Frontal','Angle_NonTruncated',HoppingRate_ID{b},HoppingTrialNumber{q},KneeAngleFrontal_NonTruncated_IndividualHops);
                                ...
                                David_DissertationDataStructure = setfield(David_DissertationDataStructure,'Post_Quals',GroupList{m}, ParticipantList{n},'IndividualHops',LimbID{a},...
                                    'Knee','Transverse','Angle_NonTruncated',HoppingRate_ID{b},HoppingTrialNumber{q},KneeAngleTransverse_NonTruncated_IndividualHops);
...
%                                     HoppingTrialNumber{q},  '.xlsx'] );
        ...
        %% Store Hip Data in Data Structure
                                ...
                                David_DissertationDataStructure = setfield(David_DissertationDataStructure,'Post_Quals',GroupList{m}, ParticipantList{n},'IndividualHops',LimbID{a},...
                                    'Hip','Sagittal','Angle_NonTruncated',HoppingRate_ID{b},HoppingTrialNumber{q},HipAngleSagittal_NonTruncated_IndividualHops);
                                ...
                                David_DissertationDataStructure = setfield(David_DissertationDataStructure,'Post_Quals',GroupList{m}, ParticipantList{n},'IndividualHops',LimbID{a},...
                                    'Hip','Frontal','Angle_NonTruncated',HoppingRate_ID{b},HoppingTrialNumber{q}, HipAngleFrontal_NonTruncated_IndividualHops);
                                ...
                                David_DissertationDataStructure = setfield(David_DissertationDataStructure,'Post_Quals',GroupList{m}, ParticipantList{n},'IndividualHops',LimbID{a},...
                                    'Hip','Transverse','Angle_NonTruncated',HoppingRate_ID{b},HoppingTrialNumber{q},HipAngleTransverse_NonTruncated_IndividualHops);
...
%% Store Segment Data in Data Structure
                                ...
                                David_DissertationDataStructure = setfield(David_DissertationDataStructure,'Post_Quals',GroupList{m}, ParticipantList{n},'IndividualHops',LimbID{a},...
                                    'Foot','Sagittal','Angle',HoppingRate_ID{b},HoppingTrialNumber{q},FootAngleSagittal_IndividualHops);

                                David_DissertationDataStructure = setfield(David_DissertationDataStructure,'Post_Quals',GroupList{m}, ParticipantList{n},'IndividualHops',LimbID{a},...
                                    'Foot','Sagittal','Angle_NonTruncated',HoppingRate_ID{b},HoppingTrialNumber{q},FootAngleSagittal_NonTruncated_IndividualHops);
                                
                                David_DissertationDataStructure = setfield(David_DissertationDataStructure,'Post_Quals',GroupList{m}, ParticipantList{n},'IndividualHops',LimbID{a},...
                                    'Foot','Sagittal','Angle_ContactPhase',HoppingRate_ID{b},HoppingTrialNumber{q},FootAngleSagittal_IndividualHopsContactPhase);
                                ...
                                David_DissertationDataStructure = setfield(David_DissertationDataStructure,'Post_Quals',GroupList{m}, ParticipantList{n},'IndividualHops',LimbID{a},...
                                    'Shank','Sagittal','Angle_NonTruncated',HoppingRate_ID{b},HoppingTrialNumber{q},ShankAngleSagittal_NonTruncated_IndividualHops);
                                ...
                                David_DissertationDataStructure = setfield(David_DissertationDataStructure,'Post_Quals',GroupList{m}, ParticipantList{n},'IndividualHops',LimbID{a},...
                                    'Thigh','Sagittal','Angle_NonTruncated',HoppingRate_ID{b},HoppingTrialNumber{q},ThighAngleSagittal_NonTruncated_IndividualHops);
                                ...
                                David_DissertationDataStructure = setfield(David_DissertationDataStructure,'Post_Quals',GroupList{m}, ParticipantList{n},'IndividualHops',LimbID{a},...
                                    'Pelvis','Sagittal','Angle_NonTruncated',HoppingRate_ID{b},HoppingTrialNumber{q},PelvisAngleSagittal_NonTruncated_IndividualHops);
...
%% !!SECTION 4 - Split Power Data Up Into Individual Hops
  ...
  RowtoFill_JointBehaviorIndex_RateMeans = 1;
    ...
    if strcmp( cell2mat( ReprocessingData_Cell ), 'No' ) || strcmp( cell2mat( ReprocessingData_Cell ), 'N' )
        ...
        RowtoFill_Power_EntireContactPhase = size( Power_EntireContactPhase, 1 ) + 1;
        
        %RowtoFill for JointBehaviorIndex = current number of rows in JointBehaviorIndex
        RowstoFill_JointBehaviorIndex = size( JointBehaviorIndex, 1) + 1;
    ...
    %If we ARE reprocessing data, initialize JointBehaviorIndex and Power_EntireContactPhase
      ...
      Power_EntireContactPhase = NaN(1, 158);
...
%% Begin N For Loop - Loop Through Participants
        ...
        for n = 1    : numel(ParticipantList)
            ...
            %If you HAVE added any new participants, ask whether we added Participant N
            ...
            %If we said that we do want to see plots, ask if we want to see plots for Participant N
            ...
            %If we said we don't want to see any plots, automatically tell code not to show plots for
            %Participant N
...
%% Initialize Variables For Each Hop
                                ...
                                KneePercentMEE_ofAnkleandKneeMEE_Propulsion = NaN( numel(GContactBegin_MoCapFrameNumbers(:,q)), 1);
                                    ...
                                    FootSagittalAngVel_BrakingPhase_L5S1AsReference = NaN( 1, 1 );
                                    FootSagittalAngVel_PropulsionPhase_L5S1AsReference = NaN( 1, 1 );
                                    ...
                                    PelvisSagittalAngVel_BrakingPhase_L5S1AsReference = NaN( 1, 1 );
                                    PelvisSagittalAngVel_PropulsionPhase_L5S1AsReference = NaN( 1, 1 );
...
%% Split L5-S1 vertical position into contact phase of Individual Hops
                                         ...
                                         %L5-S1 vertical position
                                            %ATx25 is missing L5-S1 marker for Involved Limb, 2.33 Hz. Use LPSIS
                                            %instead
                                        ...
                                        elseif strcmp( ParticipantList{ n }, 'ATx65' ) && strcmp( LimbID{a}, 'InvolvedLimb' ) && ~strcmp( HoppingRate_ID{ b }, 'PreferredHz' )
                                             ...
                                             L5S1VerticalPosition_IndividualHopsContactPhase(1:NumEl_SthHopContactPhase_MoCapSamplingHz(s,q),s) =...
                                                HoppingTrialP_OriginalDataTable.RPSIS_2(AllFrames_SthHopContactPhase_MoCap);

                                        %ATx65 had poor L5-S1 tracking. Use RPSIS instead, for Involved Limb 2.0 and 2.33 Hz Hopping. Will also use for Non-Involved Limb 2.33 Hz Hopping         
                                        elseif strcmp( ParticipantList{ n }, 'ATx65' ) && strcmp( LimbID{a}, 'NonInvolvedLimb' ) && strcmp( HoppingRate_ID{ b }, 'TwoPoint3Hz' )
                                            
                                             L5S1VerticalPosition_IndividualHopsContactPhase(1:NumEl_SthHopContactPhase_MoCapSamplingHz(s,q),s) =...
                                                HoppingTrialP_OriginalDataTable.RPSIS_2(AllFrames_SthHopContactPhase_MoCap);

                                        %ATx65 had poor L5-S1 tracking. Use RPSIS instead, for Involved Limb 2.0 and 2.33 Hz Hopping. Will also use for Non-Involved Limb 2.33 Hz Hopping         
                                        elseif strcmp( ParticipantList{ n }, 'HC32' ) && strcmp( LimbID{a}, 'RightLimb' ) && strcmp( HoppingRate_ID{ b }, 'TwoPoint3Hz' )
...
%% Split Joint Power and Angular Velocity into Absorption and Generation Phases Based on L5S1 Position
                                  ...
                                  PelvisSagittalAngle_BrakingPhase_L5S1AsReference( 1 : LengthofBrakingPhase(s), s ) =  PelvisAngleSagittal_IndividualHopsContactPhase( 1 : FrameofMinL5S1Position_EndBraking(s), s );
                                          ...
                                          %Angular velocity
                                   FootSagittalAngVel_BrakingPhase_L5S1AsReference( 1 : LengthofBrakingPhase(s), s ) =  FootAngVelSagittal_IndividualHopsContactPhase( 1 : FrameofMinL5S1Position_EndBraking(s), s );
                                  ...
                                  PelvisSagittalAngVel_BrakingPhase_L5S1AsReference( 1 : LengthofBrakingPhase(s), s ) =  PelvisAngVelSagittal_IndividualHopsContactPhase( 1 : FrameofMinL5S1Position_EndBraking(s), s );
                                  ...
                                  PelvisSagittalAngle_PropulsionPhase_L5S1AsReference( 1 : LengthofPropulsionPhase(s), s ) =  PelvisAngleSagittal_IndividualHopsContactPhase( FrameofMinL5S1Position_BeginPropulsion(s) : NumEl_SthHopContactPhase_MoCapSamplingHz(s,q), s );
                                          ...
                                          %Angular velocity
                                   FootSagittalAngVel_PropulsionPhase_L5S1AsReference( 1 : LengthofPropulsionPhase(s), s ) =  FootAngVelSagittal_IndividualHopsContactPhase( FrameofMinL5S1Position_BeginPropulsion(s) : NumEl_SthHopContactPhase_MoCapSamplingHz(s,q), s );
                                  ...
                                  ThighSagittalAngVel_PropulsionPhase_L5S1AsReference( 1 : LengthofPropulsionPhase(s), s ) =  ThighAngVelSagittal_IndividualHopsContactPhase( FrameofMinL5S1Position_BeginPropulsion(s) : NumEl_SthHopContactPhase_MoCapSamplingHz(s,q), s );
                                   PelvisSagittalAngVel_PropulsionPhase_L5S1AsReference( 1 : LengthofPropulsionPhase(s), s ) =  PelvisAngVelSagittal_IndividualHopsContactPhase( FrameofMinL5S1Position_BeginPropulsion(s) : NumEl_SthHopContactPhase_MoCapSamplingHz(s,q), s );
...
%% Plot Joint Power - Split into Absorption and Generation Phases
                                     ...
                                     if  strcmp( cell2mat( ShowPlots_Cell ), 'Yes' )
                                        ...
                                        if s == numel(GContactBegin_MoCapFrameNumbers(:,q))
                                            ...
                                            %Set the size, name, and background color of the figure
                                            figure('Color','#F5F5DC','Units', 'Normalized', 'OuterPosition', [ 0.05, 0.05, 0.9, 0.9 ],'Name',['Check Splitting of Joint Power into Braking and Propulsion Phases' ParticipantList{n} '  ' LimbID{a} '  '  ' _ ' HoppingRate_ID{b} '  ' HoppingTrialNumber{q} '  ' 'Hop# ' num2str(s)],'Visible',"on"  )
     ...
     %% Plot Joint Torque - Split into Absorption and Generation Phases
                                        ...
                                        if s == numel(GContactBegin_MoCapFrameNumbers(:,q))
                                            ...
                                            %Set the size, name, and background color of the figure
                                            figure('Color','#F5F5DC','Units', 'Normalized', 'OuterPosition', [ 0.05, 0.05, 0.9, 0.9 ],'Name',['Check Splitting of Joint Torque into Braking and Propulsion Phases' ParticipantList{n} '  ' LimbID{a} '  '  ' _ ' HoppingRate_ID{b} '  ' HoppingTrialNumber{q} '  ' 'Hop# ' num2str(s)],'Visible',"on"  )
    ...
    %% Plot Joint Angular Velocity - Split into Absorption and Generation Phases
                                        ...
                                        %angular velocity time series
                                            ...
                                            %Ankle
                                        s_AnkleAngVel = sprintf('Angular Velocity (%c/s) [- = PF ',char(176));

                                            %Knee and Hip
                                        s_KneeHipAngVel = sprintf('Angular Velocity (%c/s) [- = Ext ]',char(176));

                                            %Pelvis
                                        s_PelvisAngVel = sprintf('Angular Velocity (%c/s) [ - = Ant ]',char(176));
                                        ...
                                        if s == numel(GContactBegin_MoCapFrameNumbers(:,q))
                                            ...
                                            %Set the size, name, and background color of the figure
                                            figure('Color','#F5F5DC','Units', 'Normalized', 'OuterPosition', [ 0.05, 0.05, 0.9, 0.9 ],'Name',['Check Splitting of Joint Angular Velocity into Braking and Propulsion Phases' ParticipantList{n} '  ' LimbID{a} '  '  ' _ ' HoppingRate_ID{b} '  ' HoppingTrialNumber{q} '  ' 'Hop# ' num2str(s)],'Visible',"on"  )
...
%% Plot Ankle - Shank Angular Velocity - Split into Braking and Propulsion Phases
                                            ...
                                            %Set the size, name, and background color of the figure
                                            figure('Color','#F5F5DC','Units', 'Normalized', 'OuterPosition', [ 0.05, 0.05, 0.9, 0.9 ],'Name',['Plot Ankle and Shank Angular Velocity, Split into Braking and Propulsion Phases' ParticipantList{n} '  ' LimbID{a} '  '  ' _ ' HoppingRate_ID{b} '  ' HoppingTrialNumber{q} '  ' 'Hop# ' num2str(s)],'Visible',"on"  )
                                            ...
                                            %phase
                                            subplot(3, 2, 3)
                                            plot(TimeVector_PowerAbsorption, FootSagittalAngVel_BrakingPhase_L5S1AsReference,'LineWidth',1.5)
                                            hold on
                                            %Create a horizontal line at y-intercept of 0
                                            L = line( [ 0  max( [ max(TimeVector_PowerAbsorption), max( TimeVector_PowerGeneration) ] ) ], [0 0]);
                                            L.LineWidth = 1.2;
                                            L.Color = 'k';
                                            hold off
                                            title('Foot Angular Velocity - Braking Phase','FontSize',16)
                                            xlabel('Time (s)','FontSize',14)
                                            ylabel( s_PelvisAngVel, 'FontSize',14)
                                            ylim( [-500, 500] )
                                            yticks( -500 : 100 : 500 )
                                            legend('Location','bestoutside')
                                            ...
                                            %phase
                                            subplot(3, 2, 4)
                                            plot(TimeVector_PowerGeneration, FootSagittalAngVel_PropulsionPhase_L5S1AsReference,'LineWidth',1.5)
                                            hold on
                                            %Create a horizontal line at y-intercept of 0
                                            L = line( [ 0  max( [ max(TimeVector_PowerAbsorption), max( TimeVector_PowerGeneration) ] ) ], [0 0]);
                                            L.LineWidth = 1.2;
                                            L.Color = 'k';
                                            hold off
                                            title('Foot Angular Velocity - Propulsion Phase','FontSize',16)
                                            xlabel('Time (s)','FontSize',14)
                                            ylabel( s_PelvisAngVel, 'FontSize',14)
                                            ylim( [-500, 500] )
                                            yticks( -500 : 100 : 500 )
...
%% Plot Knee - Shank - Thigh Angular Velocity - Split into Braking and Propulsion Phases
                                            ...
                                            %Set the size, name, and background color of the figure
                                            figure('Color','#F5F5DC','Units', 'Normalized', 'OuterPosition', [ 0.05, 0.05, 0.9, 0.9 ],'Name',['Plot Knee, Shank, and Thigh Angular Velocity, Split into Braking and Propulsion Phases' ParticipantList{n} '  ' LimbID{a} '  '  ' _ ' HoppingRate_ID{b} '  ' HoppingTrialNumber{q} '  ' 'Hop# ' num2str(s)],'Visible',"on"  )
...
%% Plot Hip  - Thigh - Pelvis Angular Velocity - Split into Braking and Propulsion Phases
                                            ...
                                            %Set the size, name, and background color of the figure
                                            figure('Color','#F5F5DC','Units', 'Normalized', 'OuterPosition', [ 0.05, 0.05, 0.9, 0.9 ],'Name',['Plot Hip, Thigh, and Pelvis Angular Velocity, Split into Braking and Propulsion Phases' ParticipantList{n} '  ' LimbID{a} '  '  ' _ ' HoppingRate_ID{b} '  ' HoppingTrialNumber{q} '  ' 'Hop# ' num2str(s)],'Visible',"on"  )
                                            ...
                                            %phase
                                            subplot(3, 2, 5)
                                            plot(TimeVector_PowerAbsorption, PelvisSagittalAngVel_BrakingPhase_L5S1AsReference,'LineWidth',1.5)
                                            hold on
                                            %Create a horizontal line at y-intercept of 0
                                            L = line( [ 0  max( [ max(TimeVector_PowerAbsorption), max( TimeVector_PowerGeneration) ] ) ], [0 0]);
                                            L.LineWidth = 1.2;
                                            L.Color = 'k';
                                            hold off
                                            title('Pelvis Angular Velocity - Braking Phase','FontSize',16)
                                            xlabel('Time (s)','FontSize',14)
                                            ylabel( s_PelvisAngVel, 'FontSize',14)
                                            ylim( [-500, 500] )
                                            yticks( -500 : 100 : 500 )
                                            ...
                                            %phase
                                            subplot(3, 2, 6)
                                            plot(TimeVector_PowerGeneration, PelvisSagittalAngVel_PropulsionPhase_L5S1AsReference,'LineWidth',1.5)
                                            hold on
                                            %Create a horizontal line at y-intercept of 0
                                            L = line( [ 0  max( [ max(TimeVector_PowerAbsorption), max( TimeVector_PowerGeneration) ] ) ], [0 0]);
                                            L.LineWidth = 1.2;
                                            L.Color = 'k';
                                            hold off
                                            title('Pelvis Angular Velocity - Propulsion Phase','FontSize',16)
                                            xlabel('Time (s)','FontSize',14)
                                            ylabel( s_PelvisAngVel, 'FontSize',14)
                                            ylim( [-500, 500] )
                                            yticks( -500 : 100 : 500 )
...
%% Calculate Hopping Height
                                ...
                                elseif strcmp( ParticipantList{ n }, 'ATx65' ) && strcmp( LimbID{a}, 'InvolvedLimb' ) && ~strcmp( HoppingRate_ID{ b }, 'PreferredHz' )
                                    ...
                                    %Hopping height = maximum vertical position of L5-S1 marker (during flight phase) minus
                                    %vertical position at end of ground contact phase
                                    HoppingHeight(s) = max( HoppingTrialP_OriginalDataTable.RPSIS_2( GContactEnd_forHoppingHeight_MoCapFrameNumbers( s ): GContactBegin_forHoppingHeight_MoCapFrameNumbers( s ) ), [],  'omitnan'  ) - HoppingTrialP_OriginalDataTable.RPSIS_2( GContactEnd_forHoppingHeight_MoCapFrameNumbers(s) );
...
%% !!ADD Total and Percent Positive and Negative Power Data to a Table for Exporting to R
                                ...
                                if strcmp( cell2mat( AddedParticipantNData_Cell ), 'No' ) || strcmp( cell2mat( AddedParticipantNData_Cell ), 'N' )
                                    ...
                                    Power_EntireContactPhase( RowtoFill_Power_EntireContactPhase, 90) = Morphology;
                                     
                                     %Set theVAS rating
                                    Power_EntireContactPhase(RowtoFill_Power_EntireContactPhase, 91) = VAS;
                                    ...
                                    Power_EntireContactPhase(RowtoFill_Power_EntireContactPhase, 153) = AnkleTorqueImpulse_Braking_Sagittal_NoFlexTorq( s );
                                    Power_EntireContactPhase(RowtoFill_Power_EntireContactPhase, 154) = AnkleTorqueImpulse_Propulsion_Sagittal_NoFlexTorq( s );
                                    Power_EntireContactPhase(RowtoFill_Power_EntireContactPhase, 155) = AnkleTorqueImpulse_Braking_Frontal_NoFlexTorq( s );
                                    Power_EntireContactPhase(RowtoFill_Power_EntireContactPhase, 156) = AnkleTorqueImpulse_Propulsion_Frontal_NoFlexTorq( s );
                                    Power_EntireContactPhase(RowtoFill_Power_EntireContactPhase, 157) = AnkleTorqueImpulse_Braking_Transverse_NoFlexTorq( s );
                                    Power_EntireContactPhase(RowtoFill_Power_EntireContactPhase, 158) = AnkleTorqueImpulse_Propulsion_Transverse_NoFlexTorq( s );
                                    ...
                                    Power_EntireContactPhase(RowtoFill_Power_EntireContactPhase, 153) = KneeTorqueImpulse_Braking_Sagittal_NoFlexTorq( s );
                                    Power_EntireContactPhase(RowtoFill_Power_EntireContactPhase, 154) = KneeTorqueImpulse_Propulsion_Sagittal_NoFlexTorq( s );
                                    Power_EntireContactPhase(RowtoFill_Power_EntireContactPhase, 155) = KneeTorqueImpulse_Braking_Frontal_NoFlexTorq( s );
                                    Power_EntireContactPhase(RowtoFill_Power_EntireContactPhase, 156) = KneeTorqueImpulse_Propulsion_Frontal_NoFlexTorq( s );
                                    Power_EntireContactPhase(RowtoFill_Power_EntireContactPhase, 157) = KneeTorqueImpulse_Braking_Transverse_NoFlexTorq( s );
                                    Power_EntireContactPhase(RowtoFill_Power_EntireContactPhase, 158) = KneeTorqueImpulse_Propulsion_Transverse_NoFlexTorq( s );
                                    ...
                                    Power_EntireContactPhase(RowtoFill_Power_EntireContactPhase, 153) = HipTorqueImpulse_Braking_Sagittal_NoFlexTorq( s );
                                    Power_EntireContactPhase(RowtoFill_Power_EntireContactPhase, 154) = HipTorqueImpulse_Propulsion_Sagittal_NoFlexTorq( s );
                                    Power_EntireContactPhase(RowtoFill_Power_EntireContactPhase, 155) = HipTorqueImpulse_Braking_Frontal_NoFlexTorq( s );
                                    Power_EntireContactPhase(RowtoFill_Power_EntireContactPhase, 156) = HipTorqueImpulse_Propulsion_Frontal_NoFlexTorq( s );
                                    Power_EntireContactPhase(RowtoFill_Power_EntireContactPhase, 157) = HipTorqueImpulse_Braking_Transverse_NoFlexTorq( s );
                                    Power_EntireContactPhase(RowtoFill_Power_EntireContactPhase, 158) = HipTorqueImpulse_Propulsion_Transverse_NoFlexTorq( s );
...
%% PLOT Hopping Height                                
                                 ...
                                 if  strcmp( cell2mat( ShowPlots_Cell ), 'Yes' )
                                     ...
                                     %Set the size, name, and background color of the figure
                                     figure('Color','#F5F5DC','Units', 'Normalized', 'OuterPosition', [ 0.05, 0.05, 0.9, 0.9 ],'Name',['Check Hopping Height  ' ParticipantList{n} '  ' LimbID{a} '  '  ' _ ' HoppingRate_ID{b} '  ' HoppingTrialNumber{q} ],'Visible',"on"  )
...
%% BEGIN Z LOOP - *Fill in JointBehaviorIndex matrix*                                
                                ...
                                for z = 1 : size( AnklePowerSagittal_IndividualHopsContactPhase, 2 )
                                    ...
                                    if strcmp( cell2mat( AddedParticipantNData_Cell ), 'No' ) || strcmp( cell2mat( AddedParticipantNData_Cell ), 'N' )
                                        ...
                                        %Set the between-limb morphology
                                        JointBehaviorIndex(RowstoFill_JointBehaviorIndex, 10) = Morphology;
                                         
                                         %Set theVAS rating
                                        JointBehaviorIndex(RowstoFill_JointBehaviorIndex, 11) = VAS;
...
%                                 string_Angle = sprintf('Angle (%c)',char(176));
% 
%                                figure('Color','#F5F5DC','Units', 'Normalized', 'OuterPosition', [ 0.05, 0.05, 0.9, 0.9 ],'Name',['Work Loop  ' ParticipantList{n} '  ' LimbID{a} '  '  ' _ ' HoppingRate_ID{b} '  ' HoppingTrialNumber{q}],'Visible',"on"  )
...
%% Begin C For Loop - Loop Through Each Joint
                ...
                for c = 1 : length( VectorofUniqueJoints ) 
                    ...
                    VectorofUniqueParticipants = unique( Power_OneJoint( :, 2 ) );
                     ...
                     %Some participants don't have the self-selected Hopping Hz. We can use these by
                     %using dif()f to take the diff between each consecutive value of
                     %VectorofUniqueParticipants. If any differences are > 1, there's a missing
                     %participant. Change VectorofUniqueParticipants to exclude this participant.
                    if sum( diff( VectorofUniqueParticipants ) > 1 ) > 0

                        ParticipantToRemove = VectorofUniqueParticipants( diff( VectorofUniqueParticipants ) > 1 );

                        VectorofUniqueParticipants = VectorofUniqueParticipants( diff( VectorofUniqueParticipants ) == 1 );
...
VariableNames_PowerEntireCycle = {'Group_ID','Participant_ID','Limb_ID','MTU_ID','Trial_ID','Hop_ID','Joint_ID', 'HoppingRate_ID',...
    ...
    'JointTorqueImpulse_Braking_Sagittal_NoFlexTorq', 'JointTorqueImpulse_Propulsion_Sagittal_NoFlexTorq',...
    'JointTorqueImpulse_Braking_Frontal_NoFlexTorq', 'JointTorqueImpulse_Propulsion_Frontal_NoFlexTorq',...
    'JointTorqueImpulse_Braking_Transverse_NoFlexTorq', 'JointTorqueImpulse_Propulsion_Transverse_NoFlexTorq' };
...
VariableNames_PowerEntireCycle = {'Group_ID','Participant_ID','Limb_ID','MTU_ID','Trial_ID','Hop_ID','Joint_ID','HoppingRate_ID',...
    ...
    'Mean_JointTorqueImpulse_Braking_Sagittal_NoFlexTorq', 'Mean_JointTorqueImpulse_Propulsion_Sagittal_NoFlexTorq',...
    'Mean_JointTorqueImpulse_Braking_Frontal_NoFlexTorq', 'Mean_JointTorqueImpulse_Propulsion_Frontal_NoFlexTorq',...
    'Mean_JointTorqueImpulse_Braking_Transverse_NoFlexTorq', 'Mean_JointTorqueImpulse_Propulsion_Transverse_NoFlexTorq',...
    ...
    'SD_TotalLimbAvgTorqImpulse_Propulsion_Transverse_NoFlexTorq', 'SD_JointAveragePropulsionTorqueImpulse_Transverse_NoFlexTorq', 'SD_JntContrbutn_LimbAvrgTorqImpuls_Trans_Propulsn_NoFlexTorq',...
     'SD_JointTorqueImpulse_Braking_Sagittal_NoFlexTorq', 'SD_JointTorqueImpulse_Propulsion_Sagittal_NoFlexTorq',...
    'SD_JointTorqueImpulse_Braking_Frontal_NoFlexTorq', 'SD_JointTorqueImpulse_Propulsion_Frontal_NoFlexTorq',...
    'SD_JointTorqueImpulse_Braking_Transverse_NoFlexTorq', 'SD_JointTorqueImpulse_Propulsion_Transverse_NoFlexTorq' };
...
VariableNames_JointPower_LimbDiff = { 'Group_ID', 'Participant_ID', 'Joint_ID', 'HoppingRate_ID',...
    ...
    'Mean_Ratio_JointWork_Propulsion_AbsorptionNeutralized', 'Mean_Ratio_WholeLimbWork_Propulsion_AbsorptionNeutralized', 'Mean_Ratio_JointWorkContrbution_Proplsion_AbsorptionNeutralized',...
    ...
    'Mean_Ratio_TotalLimbAvgTorqImpulse_Propulsn_Trans_NoFlexTorq', 'Mean_Ratio_JointAveragePropulsnTorqueImpulse_Trans_NoFlexTorq', 'Mean_Ratio_JntContrbutn_AvrgTorqImpuls_Trans_Propulsn_NoFlxTorq',...
     'Mean_Ratio_JointTorqueImpulse_Braking_Sagittal_NoFlexTorq', 'Mean_Ratio_JointTorqueImpulse_Propulsion_Sagittal_NoFlexTorq',...
    'Mean_Ratio_JointTorqueImpulse_Braking_Frontal_NoFlexTorq', 'Mean_Ratio_JointTorqueImpulse_Propulsion_Frontal_NoFlexTorq',...
    'Mean_Ratio_JointTorqueImpulse_Braking_Transverse_NoFlexTorq', 'Mean_Ratio_JointTorqueImpulse_Propulsion_Transverse_NoFlexTorq',... 
    ...
    ' SD_Ratio_JointWork_Propulsion_AbsorptionNeutralized', ' SD_Ratio_WholeLimbWork_Propulsion_AbsorptionNeutralized', ' SD_Ratio_JntWorkContrbution_Proplsion_AbsorptionNeutralized',...
    ...
    'SD_Ratio_JointTorqueImpulse_Braking_Sagittal_NoFlexTorq', 'SD_Ratio_JointTorqueImpulse_Propulsion_Sagittal_NoFlexTorq',...
    'SD_Ratio_JointTorqueImpulse_Braking_Frontal_NoFlexTorq', 'SD_Ratio_JointTorqueImpulse_Propulsion_Frontal_NoFlexTorq',...
    'SD_Ratio_JointTorqueImpulse_Braking_Transverse_NoFlexTorq', 'SD_Ratio_JointTorqueImpulse_Propulsion_Transverse_NoFlexTorq' };
